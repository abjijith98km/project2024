...
const index = () => {
  ...
  const [emailVerificationBannerActive, setemailVerificationBannerActive] =
    useState(false);
              ...
              <div className="row">
                <div className="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                  <div className="card card-plain mt-1">
                    ...
                    <div className="card-body">
                      <form onSubmit={(e) => handleRegister(e)}>
                        ...
                        <div className="text-center">
                          <button
                            type="submit"
                            className="btn bg-gradient-info w-100 mt-4 mb-0 d-flex align-items-center justify-content-center">
                            Register
                            {loading && (
                              <div
                    ...
                    <p className="mb-0 card-header bg-transparent">
                      Already registered?{" "}
                      <Link className="link" href={"/players/login"}>
                        Login
                      </Link>
                    </p>
                  </div>
                      ...
                      <form onSubmit={(e) => handleVerification(e)}>
                        ...
                        <div className="mb-3">
                          <input
                            ...
                            aria-describedby="authtoken-addon"
                            ref={authtokenref}
                            required
                          />
                        </div>
